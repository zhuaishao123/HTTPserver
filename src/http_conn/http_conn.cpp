...
void http_conn::close_conn(){
    if(m_sockfd != -1){
        ...
        m_sockfd = -1;
        m_user_count--; //关闭一个链接，总用户数-1
    }
}

//循环读取客户数据，直到无数据可读或对方给关闭连接
bool http_conn::read(){
...
http_conn::HTTP_CODE http_conn::parse_request_line(char * text){
    ...
    *m_version++ = '\0';
    ...
    //http://192.168.160.129:8080/index.html
    if(strncasecmp(m_url,"http://",7) == 0){
        m_url += 7;  // 192.168.160.129:8080/index.html
